...
export default class extends AbstractView {
    ...
    getScripts() {
        return [
            ...
            "/static/js/views/scripts/delete_workout_plan.js", //trainer

            "/static/js/views/scripts/create_new_admin.js", //admin
            "/static/js/views/scripts/ban_active_account.js", //admin
            "/static/js/views/scripts/degraded_user_acc.js", //admin
    ...
    async getHtml() {
        return `
            <h1>Your Private Part Visible Only to You! Administrator Version!</h1>
                <div id="userplace_main_box">
                    ...
                    <div id="admin_main_box">
                        <div id="create_new_admin_box">
                            <p id="create_new_admin_text">Create New Administrator:</p>
                            <div id="create_new_admin_select_box">
                                
                                <p class="workout_plan_entry_text">Name:</p>
                                <select class="select_max_width_3" id="create_new_admin_choose" data-second-select="create_new_admin_choose_option">
                                </select></br>

                                <p class="workout_plan_entry_text">Username:</p>
                                <select class="select_max_width_2" id="create_new_admin_choose_option">
                                    <option>Choose Name</option>
                                </select>
                            </div>
                            <input type="button" value="Create" id="create_new_admin_button"/>
                        </div>

                        <div id="ban_activ_user_acc">
                            <div class="show_workout_plan_options_2">
                                <input type="radio" name="ban_activ_user_accoption" value="Activate" checked>Activate</br>
                                <input type="radio" name="ban_activ_user_accoption" value="Deactivate">Deactivate
                            </div>

                            <div id="create_new_admin_select_box">
                                
                                <p class="workout_plan_entry_text">Name:</p>
                                <select class="select_max_width_3 "id="ban_activ_user_acc_choose" data-second-select="ban_activ_user_acc_choose_option">
                                </select></br>

                                <p class="workout_plan_entry_text">Username:</p>
                                <select class="select_max_width_2" id="ban_activ_user_acc_choose_option">
                                    <option>Choose Name</option>
                                </select>
                            </div>

                            <p id="count_workout_plan_users_text">account.</p>

                            <input type="button" value="Action" id="ban_activ_user_acc_button"/>
                        </div>

                        <div id="degraded_user_account_box">
                            <div id="degraded_user_account_help_box_1">
                                <p id="degraded_user_account_text">Degraded:</p>
                                
                                <p class="workout_plan_entry_text">Name:</p>
                                <select class="select_max_width_3 "id="degraded_user_account_choose" data-second-select="degraded_user_account_choose_option">
                                </select></br>

                                <p class="workout_plan_entry_text">Username:</p>
                                <select class="select_max_width_2" id="degraded_user_account_choose_option">
                                    <option>Choose Name</option>
                                </select>
                            </div>

                            <div id="degraded_user_account_help_box_2">
                                <p id="degraded_user_account_text">To: </p>
                                    <select id="degraded_user_account_new_value">
                                        <option>User</option>
                                        <option>Trainer</option>
                                    </select>
                            </div>
                            <input type="button" value="Action" id="degraded_user_account_button"/>
                        </div>
                    </div>
                </div> 
        `;
